...
public class AbstractFactoryTest {
    public static void main(String[] args) {
        if (args.length != 2) {
            ...
            System.out.println("Example 1: java Main list.html ch10.listfactory.ListFactory");
            System.out.println("Example 2: java Main div.html ch10.divfactory.DivFactory");
            System.exit(0);
        }
